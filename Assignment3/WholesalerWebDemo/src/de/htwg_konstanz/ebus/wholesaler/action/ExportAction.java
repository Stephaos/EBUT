...
import de.htwg_konstanz.ebus.wholesaler.main.ExportXML;
	...
	public String execute(HttpServletRequest request, HttpServletResponse response, ArrayList<String> errorList) {
		...
		if (loginBean != null && loginBean.isLoggedIn()) {
			...
			if (Security.getInstance().isUserAllowed(loginBean.getUser(), Security.RESOURCE_ALL,
				...
				//---- Creates export util Instance and returns path to file or Error list
				ExportXML Export = new ExportXML(request, response, errorList);
