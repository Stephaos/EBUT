 ...
 * generated in the de.htwg_konstanz.ebus.ess.ws.delivery package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeliveryServiceFault_QNAME = new QName("http://www.htwg-konstanz.de/ebsf/ws/delivery", "DeliveryServiceFault");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.htwg_konstanz.ebus.ess.ws.delivery
     * 
     */
    ...
    /**
     * Create an instance of {@link DeliveryServiceRequest }
     * 
     */
    public DeliveryServiceRequest createDeliveryServiceRequest() {
        return new DeliveryServiceRequest();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.htwg-konstanz.de/ebsf/ws/delivery", name = "DeliveryServiceFault")
    public JAXBElement<String> createDeliveryServiceFault(String value) {
        return new JAXBElement<String>(_DeliveryServiceFault_QNAME, String.class, null, value);
    }
