 ...
 * generated in the de.htwg_konstanz.ebus.ess.ws.invoice package. 
...
public class ObjectFactory {
    ...
    private final static QName _InvoiceServiceFault_QNAME = new QName("http://www.htwg-konstanz.de/ebsf/ws/invoice", "InvoiceServiceFault");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.htwg_konstanz.ebus.ess.ws.invoice
     * 
     */
    ...
    /**
     * Create an instance of {@link InvoiceServiceResponse }
     * 
     */
    public InvoiceServiceResponse createInvoiceServiceResponse() {
        return new InvoiceServiceResponse();
    }

    /**
     * Create an instance of {@link InvoiceServiceRequest }
     * 
     */
    public InvoiceServiceRequest createInvoiceServiceRequest() {
        return new InvoiceServiceRequest();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.htwg-konstanz.de/ebsf/ws/invoice", name = "InvoiceServiceFault")
    public JAXBElement<String> createInvoiceServiceFault(String value) {
        return new JAXBElement<String>(_InvoiceServiceFault_QNAME, String.class, null, value);
    }
