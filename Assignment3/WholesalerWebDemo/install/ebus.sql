...
INSERT INTO `product` (`materialnumber`, `ordernumber_supplier`, `shortdescription`, `longdescription`, `ordernumber_customer`, `shortdescription_customer`, `longdescription_customer`, `manufacturertypedescription`, `supplier`, `manufacturer`, `productstatus`, `producttype`, `productcategory`, `remark`) VALUES
	...
	(8, 'mer-stiftbox-1', 'HTWG-Stiftebox', 'Staedtler Stiftebox mit HTWG-Aufkleber, enthält 4 Stifte, aufstellbar', 'mer-stiftbox-1', 'HTWG-Stiftebox', 'Staedtler Stiftebox mit HTWG-Aufkleber, enthält 4 Stifte, aufstellbar', NULL, '10', 'HTWG Konstanz', NULL, NULL, 'Alle', NULL),
	...
	(10, 'mer-zeumappe-1', 'HTWG-Zeugnismappe', 'weiße Mappe mit Cyan-logo, innen Cyan-Wellenmuster, für wenige Blätter', 'mer-zeumappe-1', 'HTWG-Zeugnismappe', 'weiße Mappe mit Cyan-logo, innen Cyan-Wellenmuster, für wenige Blätter', NULL, '10', 'HTWG Konstanz', NULL, NULL, 'Alle', NULL),
...
INSERT INTO `ebus`.`order_customer` (`orderid`, `quotationref`, `customer`, `orderdate`, `ordertype`, `orderid_customer`, `invoiceaddress`, `deliveryaddress`, `currency`, `remark`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `pricetotal_net`, `pricetotal_gross`, `taxtotal`, `taxamount`, `totallineitems`, `xml_file_request`, `xml_file_response`, `is_rejected`, `is_splitted`) VALUES ('1', NULL, '10', '2016-01-12 00:00:00', NULL, 1, '10', '10', 'EUR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '<ORDER>JUST FOR TEST PURPOSES</ORDER>', '<ORDER_RESPONSE>JUST FOR TEST PURPOSES</ORDER_RESPONSE>', '0', '0');
INSERT INTO `ebus`.`orderitem_customer` (`orderref`, `itemnumber`, `ordernumber_customer`, `productdescription`, `orderamount`, `orderunit`, `contentunit`, `no_cu_per_ou`, `unitprice`, `itemprice`, `pricetype`, `pricequantity`, `taxrate`, `taxamount`, `deliveryaddress`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `remark`, `ordertype`, `is_rejected`) VALUES ('1', '1', 'mer-penbook-1', 'HTWG-Pen Book', '10', 'pcs', NULL, '1', NULL, '30.50', NULL, NULL, '0.19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0');
INSERT INTO `ebus`.`orderitem_customer` (`orderref`, `itemnumber`, `ordernumber_customer`, `productdescription`, `orderamount`, `orderunit`, `contentunit`, `no_cu_per_ou`, `unitprice`, `itemprice`, `pricetype`, `pricequantity`, `taxrate`, `taxamount`, `deliveryaddress`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `remark`, `ordertype`, `is_rejected`) VALUES ('1', '20', '3198044', 'MAUI WOWIE Badeshorts Frauen', '5', 'pcs', NULL, '1', NULL, '29.99', NULL, NULL, '0.19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0');

INSERT INTO `ebus`.`order_customer` (`orderid`, `quotationref`, `customer`, `orderdate`, `ordertype`, `orderid_customer`, `invoiceaddress`, `deliveryaddress`, `currency`, `remark`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `pricetotal_net`, `pricetotal_gross`, `taxtotal`, `taxamount`, `totallineitems`, `xml_file_request`, `xml_file_response`, `is_rejected`, `is_splitted`) VALUES ('2', NULL, '10', '2016-01-13 10:00:00', NULL, 2, '10', '10', 'EUR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '<ORDER>JUST FOR TEST PURPOSES</ORDER>', '<ORDER_RESPONSE>JUST FOR TEST PURPOSES</ORDER_RESPONSE>', '0', '0');
INSERT INTO `ebus`.`orderitem_customer` (`orderref`, `itemnumber`, `ordernumber_customer`, `productdescription`, `orderamount`, `orderunit`, `contentunit`, `no_cu_per_ou`, `unitprice`, `itemprice`, `pricetype`, `pricequantity`, `taxrate`, `taxamount`, `deliveryaddress`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `remark`, `ordertype`, `is_rejected`) VALUES ('2', '1', 'mer-penbook-1', 'HTWG-Pen Book', '10', 'pcs', NULL, '1', NULL, '30.50', NULL, NULL, '0.19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0');
INSERT INTO `ebus`.`orderitem_customer` (`orderref`, `itemnumber`, `ordernumber_customer`, `productdescription`, `orderamount`, `orderunit`, `contentunit`, `no_cu_per_ou`, `unitprice`, `itemprice`, `pricetype`, `pricequantity`, `taxrate`, `taxamount`, `deliveryaddress`, `partialshipment`, `transport`, `specialtreatment`, `internationalrestrictions`, `remark`, `ordertype`, `is_rejected`) VALUES ('2', '20', '3198044', 'MAUI WOWIE Badeshorts Frauen', '5', 'pcs', NULL, '1', NULL, '29.99', NULL, NULL, '0.19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0');

insert into order_purchase (orderdate, ordertype, orderid_supplier, remark, partialshipment, transport, specialtreatment, internationalrestrictions, pricetotal_net, pricetotal_gross, taxtotal, taxamount, totallineitems, xml_file_request, xml_file_response, is_rejected, supplier, currency, invoiceaddress, deliveryaddress, orderid) values ('2016-01-12 18:29:07', null, '1', null, null, null, null, null, null, null, null, null, 0, null, null, 0, '10', 'EUR', '10', '10', 'OID-1_SID-10');
insert into orderitem_purchase (ordernumber_supplier, productdescription, orderamount, orderunit, contentunit, no_cu_per_ou, unitprice, itemprice, pricetype, pricequantity, taxrate, taxamount, partialshipment, transport, specialtreatment, internationalrestrictions, remark, is_rejected, deliveryaddress, orderref, itemnumber) values ('mer-penbook-1', 'HTWG-Pen Book', 10, 'pcs', null, null, 30.50, 30.50, null, null, 0.1900, null, null, null, null, null, null, 0, null, 'OID-1_SID-10', 1);
insert into order_purchase (orderdate, ordertype, orderid_supplier, remark, partialshipment, transport, specialtreatment, internationalrestrictions, pricetotal_net, pricetotal_gross, taxtotal, taxamount, totallineitems, xml_file_request, xml_file_response, is_rejected, supplier, currency, invoiceaddress, deliveryaddress, orderid) values ('2016-01-12 18:29:07', null, '1', null, null, null, null, null, null, null, null, null, 0, null, null, 0, '20', 'EUR', '10', '10', 'OID-1_SID-20');
insert into orderitem_purchase (ordernumber_supplier, productdescription, orderamount, orderunit, contentunit, no_cu_per_ou, unitprice, itemprice, pricetype, pricequantity, taxrate, taxamount, partialshipment, transport, specialtreatment, internationalrestrictions, remark, is_rejected, deliveryaddress, orderref, itemnumber) values ('3198044', 'MAUI WOWIE Badeshorts Frauen', 5, 'pcs', null, null, 29.99, 29.99, null, null, 0.1900, null, null, null, null, null, null, 0, null, 'OID-1_SID-20', 20);

update order_customer set orderdate='2016-01-12 00:00:00', ordertype=null, orderid_customer='1', remark=null, partialshipment=null, transport=null, specialtreatment=null, internationalrestrictions=null, pricetotal_net=null, pricetotal_gross=null, taxtotal=null, taxamount=null, totallineitems=2, xml_file_request=null, xml_file_response=null, is_rejected=0, is_splitted=1, customer='10', currency='EUR', invoiceaddress='10', deliveryaddress='10' where orderid='1';
update order_purchase set orderdate='2016-01-12 18:29:07', ordertype=null, orderid_supplier='1', remark=null, partialshipment=null, transport=null, specialtreatment=null, internationalrestrictions=null, pricetotal_net=305.00, pricetotal_gross=362.950000, taxtotal=57.950000, taxamount=null, totallineitems=2, xml_file_request=null, xml_file_response=null, is_rejected=0, supplier='10', currency='EUR', invoiceaddress='10', deliveryaddress='10' where orderid='OID-1_SID-10';
update order_purchase set orderdate='2016-01-12 18:29:07', ordertype=null, orderid_supplier='1', remark=null, partialshipment=null, transport=null, specialtreatment=null, internationalrestrictions=null, pricetotal_net=149.95, pricetotal_gross=178.440500, taxtotal=28.490500, taxamount=null, totallineitems=2, xml_file_request=null, xml_file_response=null, is_rejected=0, supplier='20', currency='EUR', invoiceaddress='10', deliveryaddress='10' where orderid='OID-1_SID-20';